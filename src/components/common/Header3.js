...
const Header3 = () => {
  ...
  const navLinks = [
    { href: "/institute", text: "Dashboard" },
    { href: "/institute/accreditation", text: "Accreditation" },
    { href: "/institute/certificate", text: "Certificate" },
    { href: "/institute/enrollment", text: "Enrollment" },
    { href: "/institute/documents", text: "Documents" },
    { href: "/institute/verification", text: "Verification" },
    { href: "/institute/edit-profile", text: "Edit Profile" },
  ];
