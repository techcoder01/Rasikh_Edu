...
import TabBar from '../../institute/editprofile/TabBar';

const EditProfile = () => {
  const [orgName, setOrgName] = useState('Xyz Organization');
  const [website, setWebsite] = useState('www.organization.com');
